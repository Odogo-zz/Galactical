...
public class ItemManager {
	...
	public ItemStack[] getOxygenMaskShape() {
		...
		ItemStack[] maskShape = {
				...
				new ItemStack(Material.STAINED_GLASS_PANE), new ItemStack(Material.STAINED_GLASS_PANE), new ItemStack(Material.STAINED_GLASS_PANE),
				new ItemStack(Material.STAINED_GLASS_PANE), new ItemStack(Material.IRON_HELMET), new ItemStack(Material.STAINED_GLASS_PANE),
				new ItemStack(Material.STAINED_GLASS_PANE), this.getOxygenWire(), new ItemStack(Material.STAINED_GLASS_PANE),
